...
@ContextConfiguration(classes = JdbcLessonTimeDaoTestConfig.class)
@SpringJUnitConfig
@Sql({"/sql/database_create.sql", "/sql/insert_JdbcLessonTimeDaoTest.sql"})
public class JdbcLessonTimeDaoTest {
